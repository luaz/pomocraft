...
const barColor = computed(() => {
  ...
  if (props.progress <= 0.5) return "bg-blue-500";
      ...
      <div>
        <div class="relative">
          ...
          <div class="absolute top-0 left-1/2 transform -translate-x-1/2 mt-2">
            ...
            <div
              class="text-white text-8xl font-bold bg-black/30 px-4 pt-0 pb-4 m-0 rounded-xl min-w-80 text-center"
            >
              {{ timerText || "00:00" }}
            </div>
            ...
            <div class="flex justify-center mt-5" v-if="progress == 1">
              <button
                ...
                class="bg-gradient-to-r from-green-400 to-blue-500 text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl font-bold text-2xl flex items-center gap-3 border-2 border-white/20 transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-green-300/50"
              >
